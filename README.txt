...
==Disclaimer
Dr. Kevin Olbrich started this gem and has not updated it since 2007. Since I
need it for a project I'm working on in 1.9x, I'm making the requisite changes
to bring it up to date. 

None of the tests work and the code is anything but DRY. The gem itself is
working for my purposes, but I make no guarantees for anyone else. I'll make
fixes as I can.
